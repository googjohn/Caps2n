      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
          <ul className="flex flex-col font-medium  md:p-0 mt-4 border border-gray-100 bg-black md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-black dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="#" className="active nav-link block text-white bg-green text-lg  md:bg-transparent md:hover:text-green transition duration-300 ease-in-out  md:text-white md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
            </li>
            <li>
