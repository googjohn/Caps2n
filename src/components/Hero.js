    ...
    <section id="hero">
      <div className="hero-container">
        ...
        <div className="actions flex flex-col justify-center md:justify-center md:flex-row md:flex-wrap">
          <Link to='carousel' className="btn-get-started">View Gallery</Link>
          <Link to='search' className="btn-services" data-modal-target="defaultModal" data-modal-toggle="defaultModal">Find Property</Link>
        </div>
