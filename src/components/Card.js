const Card = () => {
  return (
    <div className="max-w-sm bg-gray-100 border border-gray-200 rounded-lg hover:drop-shadow-lg transition duration-500 ease-out dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
        <img className="rounded-t-lg" src="https://www.presello.com/wp-content/uploads/2022/09/29134-2.jpg" alt="" />
      </a>
      <div className="p-5">
